...
public class CreatePostValidate extends CreatePost {
	 ...
	 */
	public static boolean validatePostInfo(String o, String dest, String d, String m, String y, String h, String min,
			String tOd, CreatePost c) throws ParseException {
		...
		if (o.equals(dest)) {
			...
			JOptionPane.showMessageDialog(c, "Date must be today or after.", "Create Post", JOptionPane.INFORMATION_MESSAGE);
			succeeded = false;
		} else if (comp <= 0) {
			succeeded = true;
		}
	...
	public static boolean validatePostInfo(String o, String dest, String d, String m, String y, String h, String min,
			String tOd, Integer r, CreatePost c) throws ParseException {
