...
static boolean succeeded = false;
	 ...
	 * @return
	 */
	public ValidatePostInfoEntered(JFrame parent) {
		super(parent);
	 ...
	 * @return succeeded
	 */
	public static boolean ValidatePostInfoEntered(String name, String email, String phone, 
			String password, String reenterPass, String gradMonth, String gradYear, CreatePost c) {
	...
	public static boolean validateAccountInfoEntered(String name, String email, String phone, 
			String password, String reenterPass, String gradMonth, String gradYear, EditProfile e) {
		ArrayList<User> users = Application.userDatabase.getUserData();
		boolean emailUsed = false;
		for(User u : users) {
			if(u.getEmail().toLowerCase().equals(email.toLowerCase())) {
